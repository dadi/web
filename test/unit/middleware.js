...
describe("Middleware", function(done) {
  ...
  it("should throw error if specified page name is not specified", function(
    done
  ) {
    var pageName = null
  ...
  it.skip(
    "should throw errors when they occur in the attached middleware",
    function(done) {
      var mware = middleware("test", {
  ...
  it("should load the referenced middleware file from the filesystem", function(
    done
  ) {
    var mware = middleware("test", {
      middlewarePath: path.join(__dirname, "../app/middleware")
  ...
  it("should throw an error if the referenced middleware file can't be found", function(
    done
  ) {
    var mware = middleware("MISSING", {
      middlewarePath: path.join(__dirname, "../app/middleware")
    })
