...
describe("Event", function(done) {
  ...
  it.skip(
    "should throw error if specified page name is not specified",
    function(done) {
      var pageName = null
      var eventName = "car-reviews"
  ...
  it("should handle errors gracefully when they occur in the attached event", function(
    done
  ) {
    var pageName = "test"
  ...
  it("should load the referenced event file from the filesystem", function(
    done
  ) {
    var pageName = "test"
    var eventName = "test_event"
  ...
  it("should throw an error if the referenced event file can't be found", function(
    done
  ) {
    var pageName = "test"
