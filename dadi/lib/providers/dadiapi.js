...
class DadiApiProvider {
   ...
   * @return {void}
   */
  buildEndpoint (datasourceParams) {
    if (!datasourceParams) {
   ...
   * @return {void}
   */
  handleResponse (requestUrl, res, done) {
    setImmediate(() => {
   ...
   */
  processOutput (requestUrl, res, data, done) {
    setImmediate(() => {
   ...
   * @return {void}
   */
  processRequest (datasourceParams) {
   ...
   */
  processDatasourceParameters (datasourceParams, uri) {
   ...
   * @return {void}
   */
  getHeaders (done, authenticationRetry) {
    let headers = {
