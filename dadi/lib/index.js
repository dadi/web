...
class Server {
  ...
  loadApi (options, reload, callback) {
  ...
  initMiddleware (directoryPath, options) {
   ...
   */
  loadMiddleware (directoryPath, options) {
  ...
  updatePages (directoryPath, options, reload) {
    return help
        ...
        this.app.use(route.path, options.host, (req, res, next) => {
          ...
          if (options.component[req.method.toLowerCase()]) {
            ...
            return this.app.Router.validate(
              ...
              .then(() => {
                return options.component[req.method.toLowerCase()](
                  req,
                  res,
                  next
                )
  ...
  getSessionStore (sessionConfig, env) {
   ...
   */
  createTemporaryFile (destination) {
